...
public:
    ...
    virtual void SendMessage(::std::shared_ptr<RoomPrx> where, ::std::shared_ptr<UserPrx> who, ::std::string message, const ::Ice::Current& current) = 0;
    /// \cond INTERNAL
...
public:
    ...
    virtual void RegisterUser(::std::string name, ::std::string password, const ::Ice::Current& current) = 0;
    /// \cond INTERNAL
    ...
    virtual void getPassword(::std::string user, const ::Ice::Current& current) = 0;
    /// \cond INTERNAL
...
public:
    ...
    void SendMessage(const ::std::shared_ptr<RoomPrx>& where, const ::std::shared_ptr<UserPrx>& who, const ::std::string& message, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        _makePromiseOutgoing<void>(true, this, &UserPrx::_iceI_SendMessage, where, who, message, context).get();
    }

    template<template<typename> class P = ::std::promise>
    auto SendMessageAsync(const ::std::shared_ptr<RoomPrx>& where, const ::std::shared_ptr<UserPrx>& who, const ::std::string& message, const ::Ice::Context& context = ::Ice::noExplicitContext)
    ...
    ::std::function<void()>
    SendMessageAsync(const ::std::shared_ptr<RoomPrx>& where, const ::std::shared_ptr<UserPrx>& who, const ::std::string& message,
...
public:
    ...
    void RegisterUser(const ::std::string& name, const ::std::string& password, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        _makePromiseOutgoing<void>(true, this, &ServerPrx::_iceI_RegisterUser, name, password, context).get();
    }

    template<template<typename> class P = ::std::promise>
    auto RegisterUserAsync(const ::std::string& name, const ::std::string& password, const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<void>>().get_future())
    {
        return _makePromiseOutgoing<void, P>(false, this, &ServerPrx::_iceI_RegisterUser, name, password, context);
    }

    ::std::function<void()>
    RegisterUserAsync(const ::std::string& name, const ::std::string& password,
                      ::std::function<void()> response,
                      ::std::function<void(::std::exception_ptr)> ex = nullptr,
                      ::std::function<void(bool)> sent = nullptr,
                      const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<void>(response, ex, sent, this, &ServerPrx::_iceI_RegisterUser, name, password, context);
    }
    ...
    {
        _makePromiseOutgoing<void>(true, this, &ServerPrx::_iceI_ChangePassword, user, oldpassword, newpassword, context).get();
    }
    ...
    auto ChangePasswordAsync(const ::std::shared_ptr<UserPrx>& user, const ::std::string& oldpassword, const ::std::string& newpassword, const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<void>>().get_future())
    {
        return _makePromiseOutgoing<void, P>(false, this, &ServerPrx::_iceI_ChangePassword, user, oldpassword, newpassword, context);
    }
    ...
    ChangePasswordAsync(const ::std::shared_ptr<UserPrx>& user, const ::std::string& oldpassword, const ::std::string& newpassword,
                        ...
                        const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<void>(response, ex, sent, this, &ServerPrx::_iceI_ChangePassword, user, oldpassword, newpassword, context);
    }
    ...
    void getPassword(const ::std::string& user, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        _makePromiseOutgoing<void>(true, this, &ServerPrx::_iceI_getPassword, user, context).get();
    }

    template<template<typename> class P = ::std::promise>
    auto getPasswordAsync(const ::std::string& user, const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<void>>().get_future())
    {
        return _makePromiseOutgoing<void, P>(false, this, &ServerPrx::_iceI_getPassword, user, context);
    }

    ::std::function<void()>
    getPasswordAsync(const ::std::string& user,
                     ::std::function<void()> response,
                     ::std::function<void(::std::exception_ptr)> ex = nullptr,
                     ::std::function<void(bool)> sent = nullptr,
                     const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<void>(response, ex, sent, this, &ServerPrx::_iceI_getPassword, user, context);
    }
...
/**
 * Base class for asynchronous callback wrapper classes used for calls to
 * IceProxy::Chat::Server::begin_ChangePassword.
 * Create a wrapper instance by calling ::Chat::newCallback_Server_ChangePassword.
 */
...
/**
 * Base class for asynchronous callback wrapper classes used for calls to
 * IceProxy::Chat::Server::begin_getPassword.
 * Create a wrapper instance by calling ::Chat::newCallback_Server_getPassword.
 */
...
public:
    ...
    void SendMessage(const ::Chat::RoomPrx& where, const ::Chat::UserPrx& who, const ::std::string& message, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        end_SendMessage(_iceI_begin_SendMessage(where, who, message, context, ::IceInternal::dummyCallback, 0, true));
    }

    ::Ice::AsyncResultPtr begin_SendMessage(const ::Chat::RoomPrx& where, const ::Chat::UserPrx& who, const ::std::string& message, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_SendMessage(where, who, message, context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_SendMessage(const ::Chat::RoomPrx& where, const ::Chat::UserPrx& who, const ::std::string& message, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_SendMessage(where, who, message, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_SendMessage(const ::Chat::RoomPrx& where, const ::Chat::UserPrx& who, const ::std::string& message, const ::Ice::Context& context, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_SendMessage(where, who, message, context, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_SendMessage(const ::Chat::RoomPrx& where, const ::Chat::UserPrx& who, const ::std::string& message, const ::Chat::Callback_User_SendMessagePtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_SendMessage(where, who, message, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_SendMessage(const ::Chat::RoomPrx& where, const ::Chat::UserPrx& who, const ::std::string& message, const ::Ice::Context& context, const ::Chat::Callback_User_SendMessagePtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_SendMessage(where, who, message, context, cb, cookie);
    }
...
public:
    ...
    void RegisterUser(const ::std::string& name, const ::std::string& password, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        end_RegisterUser(_iceI_begin_RegisterUser(name, password, context, ::IceInternal::dummyCallback, 0, true));
    }

    ::Ice::AsyncResultPtr begin_RegisterUser(const ::std::string& name, const ::std::string& password, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_RegisterUser(name, password, context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_RegisterUser(const ::std::string& name, const ::std::string& password, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_RegisterUser(name, password, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_RegisterUser(const ::std::string& name, const ::std::string& password, const ::Ice::Context& context, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_RegisterUser(name, password, context, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_RegisterUser(const ::std::string& name, const ::std::string& password, const ::Chat::Callback_Server_RegisterUserPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_RegisterUser(name, password, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_RegisterUser(const ::std::string& name, const ::std::string& password, const ::Ice::Context& context, const ::Chat::Callback_Server_RegisterUserPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_RegisterUser(name, password, context, cb, cookie);
    }
...
public:
    ...
    ::Ice::AsyncResultPtr begin_ChangePassword(const ::Chat::UserPrx& user, const ::std::string& oldpassword, const ::std::string& newpassword, const ::Chat::Callback_Server_ChangePasswordPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_ChangePassword(user, oldpassword, newpassword, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_ChangePassword(const ::Chat::UserPrx& user, const ::std::string& oldpassword, const ::std::string& newpassword, const ::Ice::Context& context, const ::Chat::Callback_Server_ChangePasswordPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_ChangePassword(user, oldpassword, newpassword, context, cb, cookie);
    }
...
public:
    ...
    void getPassword(const ::std::string& user, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        end_getPassword(_iceI_begin_getPassword(user, context, ::IceInternal::dummyCallback, 0, true));
    }

    ::Ice::AsyncResultPtr begin_getPassword(const ::std::string& user, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_getPassword(user, context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_getPassword(const ::std::string& user, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getPassword(user, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_getPassword(const ::std::string& user, const ::Ice::Context& context, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getPassword(user, context, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_getPassword(const ::std::string& user, const ::Chat::Callback_Server_getPasswordPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getPassword(user, ::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_getPassword(const ::std::string& user, const ::Ice::Context& context, const ::Chat::Callback_Server_getPasswordPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getPassword(user, context, cb, cookie);
    }

    void end_getPassword(const ::Ice::AsyncResultPtr& result);
...
public:
    ...
    virtual void SendMessage(const RoomPrx& where, const UserPrx& who, const ::std::string& message, const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_SendMessage(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond
...
public:
    ...
    virtual void RegisterUser(const ::std::string& name, const ::std::string& password, const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_RegisterUser(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond
    ...
    virtual void getPassword(const ::std::string& user, const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_getPassword(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond
 ...
 * @param excb The exception method of the callback object.
 * @param sentcb The sent method of the callback object.
 * @return An object that can be passed to an asynchronous invocation of IceProxy::Chat::Server::begin_ChangePassword.
 */
 ...
 * @param excb The exception method of the callback object.
 * @param sentcb The sent method of the callback object.
 * @return An object that can be passed to an asynchronous invocation of IceProxy::Chat::Server::begin_getPassword.
 */
